 ...
 * @author dev
 */
public class ExecGUI_2 extends javax.swing.JFrame {
    private File img = null;
    /**
     * Creates new form ExecGUI_2
     */
    public ExecGUI_2() {
        initComponents();
        inicializaMenuBar();
    ...
    private void inicializaMenuBar(){
        ...
        this.jMenuFile.add(jMenuItemCargar);
        ...
        this.jMenuFile.add(jMenuItemGuardar);
    ...
    private void cargarImagen(){
        ...
        eligeArchivos.showOpenDialog(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExecGUI_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
